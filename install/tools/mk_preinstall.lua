...
file:write('patch --output=$TPU/lua51/src/linit_istools.c $TPU/lua51/src/linit.c $TPU/lua-addons/istools/lua-istools.diff\n')
file:write('cp $TPU/lua-addons/istools/istools.c $TPU/lua51/src\n')
