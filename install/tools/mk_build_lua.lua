--[[
  Генерирование скрипта build_lua.sh, собирающего окружения времени инсталяции.

  Данный скрипт (build_lua.lua) работает только в полностью установленном рабочем окружении.
  Не следует запускать этот скрипт во время инсталяции рабочего окружения.
  Во время инсталяцией следует использовать скрипт build_lua.sh, расположенный в репозитории.
--]]
